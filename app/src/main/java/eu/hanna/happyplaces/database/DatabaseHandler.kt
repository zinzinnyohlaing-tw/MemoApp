package eu.hanna.happyplaces.database
...
class DatabaseHandler (context:Context) : SQLiteOpenHelper(context, DATABASE_NAME,null, DATABASE_VERSION) {
    ...
    fun addHappyPlace (happyPlaceModel: HappyPlaceModel): Long {
        ...
        contentValues.put(KEY_LONGITUDE,happyPlaceModel.longitutde)
    ...
    fun updateHappyPlace (happyPlaceModel: HappyPlaceModel) : Int {
        ...
        val update = db.update(TABLE_HAPPY_PLACE,contentValues, KEY_ID + "=" + happyPlaceModel.id, null)
        db.close()
        return update
    }
    ...
    fun deleteHappyPlace (happyPlaceModel: HappyPlaceModel) : Int {
        val db = this.writableDatabase
        val delete = db.delete(TABLE_HAPPY_PLACE, KEY_ID + "=" + happyPlaceModel.id,null)
        db.close()
        return delete
    }
